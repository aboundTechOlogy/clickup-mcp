...
export class GitHubOAuthProvider implements OAuthServerProvider {
  ...
  constructor(config: {
    ...
    console.log('GitHub OAuth provider initialized for ClickUp MCP');
  }
  ...
  async authorize(
    ...
    console.log('Redirecting to GitHub OAuth', { state: internalState });
  ...
  async exchangeAuthorizationCode(
    ...
    console.log('OAuth token issued via GitHub', {
      clientId: client.client_id,
      expiresIn: 3600
    });
